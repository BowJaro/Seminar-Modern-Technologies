# Extract images by convert to black and white; and read text from them using Tesseract OCR
import cv2
import os
import pytesseract
...
# Create the result folder for processed images
    ...
    for contour in contours:
        ...
        if area > 10000:
            ...
            if (len(approx) == 4) and (1.2 <= ratio <= 1.8 or 3 <= ratio <= 7.5):
                ...
                process_image_for_black_white(object_image, object_path) 
        ...
        for object_path in extracted_object_paths:
            ...
            if orc_text:
                ...
                if result:
                    ...
                    count_false += 1
                print(f"This is orc text       {object_path}       {orc_text}       {str(result): >{80-len(object_path)-len(orc_text)-20}}")
